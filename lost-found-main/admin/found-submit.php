...
$sql = "SELECT * FROM items WHERE type='found' AND verification_status='pending' ORDER BY date_created DESC";
$result = $conn->query($sql);

$pageTitle = 'Submitted Found Items';
$activePage = 'found-submit';
include __DIR__ . '/includes/header.php';
?>

            <h3 class="mb-1">Submitted Found Items</h3>
            <div class="card">

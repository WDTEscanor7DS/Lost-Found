          ...
          <tbody>
            ...
            if ($recentItems && $recentItems->num_rows > 0) {
              while ($row = $recentItems->fetch_assoc()) {
                ...
                switch ($row['status']) {
                  case 'matched':
                    $statusBadge = "<span class='badge bg-label-warning'>Matched</span>";
                    break;
                  case 'claimed':
                    $statusBadge = "<span class='badge bg-label-info'>Claimed</span>";
                    break;
                  default:
                    $statusBadge = "<span class='badge bg-label-primary'>Open</span>";
                    break;
                }

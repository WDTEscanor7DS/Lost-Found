...
<h3 class="mb-4">Report Found Item</h3>
<div class="card">
  <div class="card-body">
    <form action="../backend/save.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <textarea name="description" id="descriptionBox" class="form-control" rows="4" placeholder="Describe the found item in detail..."></textarea>
      </div>
...
<script>
  ...
  function updateDescriptionHint() {
    ...
    desc.placeholder = hints[cat] || "Describe the found item in detail...";
  }
</script>

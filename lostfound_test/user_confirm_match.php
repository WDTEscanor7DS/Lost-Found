...
if ($lost_id <= 0 || $found_id <= 0) {
    ...
    if (!$match) {
        ...
        if ($current_status === 'user_confirmed') {
            // If this is the first time after clicking YES, show the full confirmation and next steps
    ...
    <div class="container">
        ...
        <?php if ($match_status === 'confirmed'): ?>
            ...
            <div class="contact-info">
                <p>Need Help?</p>
                <p>If you have any questions or need assistance, please contact our administration office or reply to this email.</p>
            </div>
        ...
        <?php elseif (in_array($match_status, ['already_confirmed', 'admin_confirmed', 'rejected'])): ?>
            <div class="contact-info">
        ...
        <div class="button-group">
            ...
            <?php if ($match_status === 'confirmed' || $match_status === 'already_confirmed'): ?>
